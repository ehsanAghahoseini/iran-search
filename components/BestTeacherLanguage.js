...
function BestTeacherLanguage(props) {
    ...
    return (
        <div className="bestteacher bg2">
            <div className="bestteacher-inner bg2">
                <div className="bestteacher-inner-head">
                    <h3>برترین</h3>
                    <h3>مدرسین</h3>
                    <h3>زبان</h3>
                    <span className="bestteacher-inner-head-span">برترین مدرسین زبان</span>
                    <Link href="/category">
                        <button>
...
export default BestTeacherLanguage;